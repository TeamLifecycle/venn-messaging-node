...
function OneSignal(keys){
  ...
  this.send = function(data, callback) {
    ...
    console.log(context.keys.app_id, context.keys.api_key, context.keys.api_key, data.deviceToken, data.message, deviceType)
    console.log("getOneSignalRegisterOptions", getOneSignalRegisterOptions(context.keys.app_id, deviceType, data.deviceToken))
