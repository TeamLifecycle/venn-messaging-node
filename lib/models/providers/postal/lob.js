...
function LobErrorStatus(response) {
  ...
  if (response.status_code == 401) this.state.code = this.StatusCodes.UNAUTHORIZED;
  else if (response.status_code == 404) this.state.code = this.StatusCodes.DATA_REJECTED;
